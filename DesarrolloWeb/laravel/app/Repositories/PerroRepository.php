...
class PerroRepository
{
    ...
    public function urlPerro()
    {
        $perro = Http::get('https://dog.ceo/api/breeds/image/random');
    ...
    public function listarAceptados()
    {
        try
        {
            $aceptado = Interaccion::where('preferencia', 'A')->get();
    ...
    public function listarRechazados()
    {
        try
        {
            $rechazados = Interaccion::where('preferencia', 'R')->get();
